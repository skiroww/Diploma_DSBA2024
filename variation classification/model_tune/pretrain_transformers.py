...
def main():
    ...
    parser.add_argument(
        "--train_data_file", 
        default=r'C:\Users\User\Documents\github\He_who_laughs_last\variation classification\train.txt', 
        type=str,help="The input training data file (a text file)."
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default=r'C:\Users\User\Documents\github\He_who_laughs_last\variation classification\out',
    ...
    parser.add_argument(
        "--eval_data_file",
        default=r'C:\Users\User\Documents\github\He_who_laughs_last\variation classification\eval.txt',
        type=str,
